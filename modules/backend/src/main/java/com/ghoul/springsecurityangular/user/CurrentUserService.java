...
public class CurrentUserService implements UserDetailsService {
  ...
  @Autowired
  public CurrentUserService(UserInMemoryRepository inMemoryRepository, UserRepository repository) {
  ...
  public CurrentUser loadUserByUsername(String username) throws UsernameNotFoundException {
    final UserEntity user = repository.findUserByUsername(username);
    if (user != null) {
